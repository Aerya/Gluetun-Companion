...
FROM --platform=$BUILDPLATFORM docker:29.8.0-cli AS docker-release
...
FROM --platform=$BUILDPLATFORM golang:1.27.1-alpine AS docker-bin
...
FROM --platform=$BUILDPLATFORM golang:1.27.1-alpine AS compose-bin
