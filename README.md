...
- **Contrôle par URL** — chaque tracker peut être activé ou ignoré individuellement pour les vérifications futures ; la liste propose aussi les actions **Tout cocher** et **Tout décocher** pour préparer rapidement une sélection ciblée
