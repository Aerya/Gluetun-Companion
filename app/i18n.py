...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'srv_profile_data_limited':   'Données insuffisantes pour différencier les profils — seul le débit de téléchargement est disponible. Lancez un benchmark complet (Sidecar) pour obtenir des résultats de latence et d\'upload.',
    ...
    'en': {
        ...
        'srv_profile_data_limited':   'Insufficient data to differentiate profiles — only download speed is available. Run a full benchmark (Sidecar) to get latency and upload results.',
        'set_api_title':           'REST API',
