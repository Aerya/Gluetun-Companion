...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'srv_modal_title':       'Ajouter un serveur',
        'srv_filter_type':       'Type de filtre',
        'srv_filter_value':      'Valeur',
        'srv_filter_hint':       'Valeur exacte telle qu\'attendue par Gluetun pour cette variable.',
        'srv_filter_ref':        'Référence AirVPN',
    ...
    'en': {
        ...
        'srv_modal_title':       'Add a server',
        'srv_filter_type':       'Filter type',
        'srv_filter_value':      'Value',
        'srv_filter_hint':       'Exact value as expected by Gluetun for this variable.',
        'srv_filter_ref':        'AirVPN reference',
