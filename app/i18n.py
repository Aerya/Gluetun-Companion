...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'dash_run_now':         'Lancer maintenant',
        ...
        'set_run_now':             'Lancer un test maintenant',
        ...
        'set_network_containers_title':  'Containers réseau Gluetun (auto-gérés)',
        'set_network_containers_hint':   'Ces containers utilisent <code>network_mode: service:gluetun</code> et sont relancés automatiquement par Companion après chaque bascule. Cochez ceux dont vous souhaitez mettre à jour l\'image avant le redémarrage.',
    ...
    'en': {
        ...
        'set_network_containers_title':  'Gluetun network containers (auto-managed)',
        'set_network_containers_hint':   'These containers use <code>network_mode: service:gluetun</code> and are restarted automatically by Companion after each switch. Check the ones whose image you want updated before restart.',
