...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'sw_filter_provider':     'Profil',
        'sw_filter_all_providers':'Tous les profils',
        'sw_flow':                'Flux',
        'ui_filter':              'Filtrer',
        ...
        'srv_profile_data_limited':   'Données insuffisantes pour différencier les profils — seul le débit de téléchargement est disponible. Trop de serveurs n\'ont pas subi assez de benchmarks complets.',
        ...
        'notif_pool_speed':   'Débit (quick bench)',

        # ── Rotation pools UI ──
        'pools_title':              'Pools de rotation',
        'pools_subtitle':           'Basculez vers un serveur aléatoire ou optimisé, sans benchmark complet. Chaque pool définit un ensemble de serveurs candidats et un mode de sélection.',
        ...
        'pools_mode_best_score':    'Meilleur score',
        ...
        'pools_top_n_label':        'Restreindre aux N mieux notés',
        'pools_top_n_hint':         'Laisser vide pour utiliser tous les candidats. Ex : 5 = seuls les 5 serveurs avec le meilleur score historique sont éligibles.',
        'pools_criteria_title':     'Critères (UNION — chaque ligne ajoute des serveurs)',
        ...
        'pools_quick_bench':        'Quick bench après bascule (proxy)',
        'pools_quick_bench_hint':   'Lance un test de débit rapide via le proxy HTTP après chaque rotation.',
        'pools_notify_label':       'Notifier à chaque rotation',
        'pools_enabled_label':      'Pool actif',
        'pools_save':               'Enregistrer',
        'pools_candidates_title':   'Serveurs candidats actuels',
        ...
        'notice_new_features_pools_b':   'Créez des groupes de serveurs qui tournent automatiquement ou manuellement — par liste, par filtre (pays, région…), par profil WireGuard, ou parmi les mieux notés. Chaque pool a son propre mode de sélection (aléatoire, round-robin, meilleur score) et peut déclencher un quick bench et une notification après chaque rotation. Page <strong>Rotation</strong> dans la navigation.',
        'notice_new_features_wg_h':      'Clé WireGuard dédiée aux tests sidecar (nouveau — obligatoire en mode WireGuard)',
        'notice_new_features_wg_b':      'Les conteneurs sidecar partageaient la même clé WireGuard que Gluetun principal, provoquant une collision de pair et coupant le tunnel principal. Il faut désormais configurer une paire de clés dédiée dans <strong>Paramètres → Clé WireGuard sidecar</strong>. Consultez le README pour les détails.',
    ...
    'en': {
        ...
        'sw_filter_provider':     'Profile',
        'sw_filter_all_providers':'All profiles',
        'sw_flow':                'Flow',
        'ui_filter':              'Filter',
        'ui_reset':               'Reset',
        ...
        'srv_profile_data_limited':   'Insufficient data to differentiate profiles — only download speed is available. Too many servers have not undergone enough full benchmarks.',
        'set_api_title':           'REST API',
        ...
        'notif_pool_speed':   'Speed (quick bench)',

        # ── Rotation pools UI ──
        'pools_title':              'Rotation pools',
        'pools_subtitle':           'Switch to a random or score-optimised server without running a full benchmark. Each pool defines a set of candidate servers and a selection mode.',
        'pools_add':                'New pool',
        'pools_empty':              'No rotation pool configured.',
        'pools_mode_random':        'Random',
        'pools_mode_round_robin':   'Round-robin',
        'pools_mode_best_score':    'Best score',
        'pools_auto_label':         'Auto',
        ...
        'pools_top_n_label':        'Restrict to top-N best-rated',
        'pools_top_n_hint':         'Leave empty to use all candidates. E.g. 5 = only the 5 highest-scoring servers are eligible.',
        'pools_criteria_title':     'Criteria (UNION — each line adds servers)',
        ...
        'pools_options_title':      'Options',
        'pools_quick_bench':        'Quick bench after switch (proxy)',
        'pools_quick_bench_hint':   'Runs a quick proxy speed test after each rotation.',
        'pools_notify_label':       'Notify on each rotation',
        'pools_enabled_label':      'Pool active',
        'pools_save':               'Save',
        'pools_candidates_title':   'Current candidate servers',
        ...
        'notice_new_features_pools_b':   'Create groups of servers that rotate automatically or manually — by list, by filter (country, region…), by WireGuard profile, or among the best-rated. Each pool has its own selection mode (random, round-robin, best score) and can trigger a quick bench and a notification after each rotation. See the <strong>Rotation</strong> page in the navigation.',
        'notice_new_features_wg_h':      'Dedicated WireGuard key for sidecar tests (new — required in WireGuard mode)',
        'notice_new_features_wg_b':      'Sidecar containers shared the same WireGuard key as the main Gluetun instance, causing a peer conflict and dropping the main tunnel. A dedicated key pair must now be configured in <strong>Settings → WireGuard sidecar key</strong>. See the README for details.',
