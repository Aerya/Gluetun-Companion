...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'set_autoswitch_label':    'Basculer automatiquement vers le <strong>meilleur serveur</strong> après chaque cycle <span class="text-muted">(score pondéré : 65% mesure actuelle + 35% historique)</span>',
    ...
    'en': {
        ...
        'set_autoswitch_label':    'Automatically switch to the <strong>best server</strong> after each cycle <span class="text-muted">(weighted score: 65% current + 35% history)</span>',
