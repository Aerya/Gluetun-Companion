...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'set_gluetun_api_port_hint':      'Port de l\'API de contrôle Gluetun (<code>HTTP_CONTROL_SERVER_PORT</code>, défaut : 8000). Utilisé pour lire l\'état VPN et les filtres actifs du container.',
    ...
    'en': {
        ...
        'set_gluetun_api_port_hint':      'Gluetun control API port (<code>HTTP_CONTROL_SERVER_PORT</code>, default: 8000). Used to read VPN state and active container filters.',
