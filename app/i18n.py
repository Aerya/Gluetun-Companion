...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'fr': {
        ...
        'srv_catalogue_modal_subtitle':   'Le sidecar Gluetun-Companion lit les JSON Gluetun et peuple ce catalogue.',
        'srv_catalogue_empty':            'Catalogue vide — cliquez sur « Rafraîchir » pour lancer le sidecar et importer les serveurs depuis le volume Gluetun.',
        ...
        'set_catalogue_subtitle':           'Importe automatiquement la liste des serveurs depuis le volume Gluetun monté.',
        'set_catalogue_enabled_label':      'Activer le catalogue (rafraîchissement automatique à chaque benchmark)',
        'set_catalogue_dir_label':          'Dossier des fichiers JSON Gluetun',
        'set_catalogue_dir_hint':           'Chemin vers le dossier <code>servers/</code> exporté par Gluetun (ex. <code>/gluetun/servers</code>). Monter le même volume en lecture seule dans Companion.',
        ...
        'set_catalogue_empty':              'Catalogue vide — utilisez « Forcer le rafraîchissement » pour que le sidecar importe les serveurs.',
        'set_catalogue_servers':            'serveurs',
        'set_catalogue_saved':              'Configuration du catalogue enregistrée.',
        'set_catalogue_compose_hint':       'Ajouter dans votre <code>docker-compose.yml</code> (service Gluetun) :',
        'set_catalogue_compose_companion':  'Et dans le service Companion :',
    ...
    'en': {
        ...
        'srv_catalogue_modal_subtitle':   'The Gluetun-Companion sidecar reads Gluetun JSON files and populates this catalogue.',
        'srv_catalogue_empty':            'Catalogue empty — click "Refresh" to launch the sidecar and import servers from the Gluetun volume.',
        ...
        'set_catalogue_subtitle':           'Automatically imports the server list from the mounted Gluetun volume.',
        'set_catalogue_enabled_label':      'Enable catalogue (auto-refresh on each benchmark)',
        'set_catalogue_dir_label':          'Gluetun JSON files directory',
        'set_catalogue_dir_hint':           'Path to the <code>servers/</code> folder exported by Gluetun (e.g. <code>/gluetun/servers</code>). Mount the same volume read-only in Companion.',
        ...
        'set_catalogue_empty':              'Catalogue empty — use "Force refresh" to have the sidecar import the servers.',
        'set_catalogue_servers':            'servers',
        'set_catalogue_saved':              'Catalogue configuration saved.',
        'set_catalogue_compose_hint':       'Add to your <code>docker-compose.yml</code> (Gluetun service):',
        'set_catalogue_compose_companion':  'And in the Companion service:',
